...
|---|---|---|
| throughput | `throughput-<workload>-<dtype>-<cpu|gpu>.png` | samples/s per backend / compiler / BLAS / device, training rows (E1, E2, E3, E4); only workloads measured at two or more batch sizes (mnist, mnist-512-256) |
